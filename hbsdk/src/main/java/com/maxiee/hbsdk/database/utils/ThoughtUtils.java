...
import com.maxiee.hbsdk.database.table.EventThoughtRelationTable;
import com.maxiee.hbsdk.database.table.ThoughtResTable;
import com.maxiee.hbsdk.database.table.ThoughtsTable;
...
public class ThoughtUtils {
    ...
    public static Thought queryThought(Cursor cursor) {
        return new Thought(queryThoughtId(cursor), queryThoughtStr(cursor), queryTiemStamp(cursor));
    }
